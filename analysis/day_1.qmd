...
```{r}
example_data <-
    here("data", "example_1.txt") %>% collect_calories()
example_top_elf <- example_data %>% calories_top_elfs()
...
#| include: FALSE
input_data <-
    here("data", "input_1.txt") %>% collect_calories()
top_elf <- input_data %>% calories_top_elfs()
